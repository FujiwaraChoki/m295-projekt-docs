...
This endpoint returns a specific task based on the ID provided in the URL.

## Parameters

| **Name** 	| **Type** 	| **Description**           	|
|----------	|----------	|---------------------------	|
| id    	| string   	| The ID of the task which is to be returned   	|

## Responses

| Status | Meaning | Description |
| ------ | ------- | ----------- |
| **200** | OK | The task was successfully indexed & returned |
